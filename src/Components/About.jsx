    ...
    return (
        ...
        <div id='About' className="lg:px-56 px-10 lg:py-0 py-20 text-center gap-5 lg:text-start flex lg:flex-row flex-col justify-between lg:gap-28 items-center">
            ...
            <div className=" h-full lg:py-40 flex flex-col justify-center lg:items-start items-center text-white">
                ...
                <p data-aos="fade-left">Hello World! I'm Rosa Valdez I'm a Full Stack Wed Developer from San Diego,CA. I have a unique ability to utilizing my soft skills to collaborate with teams to create user friendly applications. As well as working independently on my own projects. With a passion for learning and growing, I look forward to continue to refining my skills with the right company. When I am not in front of the computer, I am trying out new restaurants,going to the movies or enjoying music.</p>
